...
namespace RutaArtesanal.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddDbContext<RutaArtesanalContext>(options =>
            //options.UseSqlServer(Configuration.GetConnectionString("RutaArtesanal")));

            
            services.AddControllers();
            var Connection =Configuration.GetConnectionString("RutaArtesanal");
            services.AddDbContext<RutaArtesanalContext>(options => options.UseSqlServer(Connection));
